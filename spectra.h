...
struct spectra {
  ...
  double * DVrms2_dmeff_lin; /**< ln_DVrms2_dmeff_lin[index_tau * psp->k_size + index_k]
                                  Total linear part of ln_DVrms2_dmeff. */
  double * Vrms_dmeff;  /**< Vrms_dmeff[index_tau],
                         integrate over all (available) k */
  double * Vrms_k_dmeff;  /**< Vrms_k_dmeff[index_tau * psp->k_size + index_k],
                           integrate only above k of current mode */
  double * Vflow_k_dmeff;  /**< Vflow_k_dmeff[index_tau * psp->k_size + index_k],
                           integrate only below k of current mode */
